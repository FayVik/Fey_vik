				...
				<div className='row m-0'>
					...
					<div className={`col-lg-6 col-md-6 col-sm-12 mb-5 text-left`}>
						...
						>
							...
							<p className={`${style.text} mt-2`}>
								We will be building a simple book finder app that allows users
								to search and know more about there favorite books. Now let’s
								write some code!. As you may already know, Angular massively use
								rxjs behind the scene to handle all sort of asynchronous tasks
								like Http request, reactive forms, emitting events...
							</p>
							<div className='text-right'>
								<a
									className='link'
					...
					<div className={`col-lg-6 col-md-6 col-sm-12 mb-5 text-left`}>
						...
						>
							...
							<p className={`${style.text} mt-2`}>
								Google Docs is Google’s browser-based word processor that allows
								you to create, edit, download, and share documents online and
								access it from any computer as long as there is an internet
								connection.
							</p>
							<div className='text-right'>
								<a
